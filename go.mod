module github.com/crossplane-contrib/provider-jet-metakube
...
require (
	...
	github.com/syseleven/terraform-provider-metakube v1.0.3
...
replace github.com/hashicorp/terraform-plugin-sdk/v2 => github.com/syseleven/terraform-plugin-sdk/v2 v2.8.0-sys11-1
