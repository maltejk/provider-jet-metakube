...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-jet-metakube/apis/metakube/v1alpha1"
)
...
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), ws, s, cfg.Resources["metakube_cluster"])),
